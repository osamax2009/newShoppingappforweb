...
class SelectSearchtype extends StatelessWidget {
  const SelectSearchtype({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text("مرحبا بك في ثانوية الفارابي \n ",
          style: TextStyle(
              fontSize: 25,
              color: Colors.red
          ),
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child:  Text("بحث باستخدام التاريخ",
                      style: TextStyle(
                          fontSize: 25
                      ),
                    ),
